                ...
                <div className='w-full h-full flex justify-center items-center relative'>
                    ...
                    <div className="bg-secondary-900 z-50 opacity-100  w-[400px] flex flex-col p-6 rounded-lg">
                        <form onSubmit={handleSubmit} className='flex flex-col'>
                            <h3 className='font-rocksalt text-[18px] mb-4 text-white'> <RiAlertFill className='text-red-600'/> Estás seguro que quieres borrar esta publicación?</h3>
                            ...
                            <div className='flex gap-x-5 w-full justify-center items-center'>
                                ...
                                <button type='submit' className='flex gap-x-0.5 items-center hover:text-primary/80'> <RiCheckFill className=' text-sky-300 text-[18px] hover:text-primary/80'/> Borrar Publicación</button>
                            </div>
                        </form>
                    </div>
                </div>
