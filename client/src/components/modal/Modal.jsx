                ...
                <div className='w-full h-full flex justify-center items-center relative'>
                    ...
                    <div className="bg-secondary-900 z-50 opacity-100  w-[400px] flex flex-col p-6 rounded-lg">
                        <form onSubmit={handleSubmit} className='flex flex-col'>
                            <h3 className='font-rocksalt text-[18px] mb-4 text-white'>Editar  Publicación</h3>
                            <div className='flex justify-between gap-x-2 mb-6'>
                                <textarea className='resize-none bg-transparent w-full outline-none border-transparent border-b-white/25 border-[1px] text-[14px] text-white/70' onChange={handleChange} placeholder='Descripción...' name="description" id="description" rows="5" value={descriptionData} />
                                <RiEmotionHappyLine className='text-[17px] mt-1 cursor-pointer'/>
                            </div>
                            ...
                            <div className='flex gap-x-5 w-full justify-center items-center'>
                                ...
                                <button type='submit' className='flex gap-x-0.5 items-center hover:text-primary/80'> <RiCheckFill className=' text-sky-300 text-[18px] hover:text-primary/80'/> Guardar Cambios</button>
                            </div>
                        </form>
                    </div>
                </div>
