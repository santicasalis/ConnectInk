...
const PostDashboard = ({publication, fullName, image}) => { 
        ...
        <div className=' flex flex-col xl:w-[60%] border-transparent pb-3 border-[2px] border-b-gray-600 bg-secondary-900 rounded-md overflow-hidden m-5 ' >
            <div>
                ...
                <div className='flex flex-col'>
                    ...
                    <p className='mb-1'><span className='font-bold text-white text-[16px] mr-2'>{fullName}</span>{publication?.description}</p>
