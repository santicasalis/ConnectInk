      ...
      <div>
        <div className="flex justify-between">
          <div className="flex gap-x-2 p-2 items-center">
            ...
            <p className="text-artistfont/60 text-[13px]">
          ...
          <div className="p-2 flex items-center justify-center">
            ...
            >
              <MenuItem
                className="hover:bg-secondary-100 w-full h-full text-artistfont"
                onClick={() => dispatch(openModalAction(publication))}
              >
                <div>
                  <Link
                    href=""
              ...
              <MenuItem
                className="hover:bg-secondary-100 w-full h-full text-artistfont"
                onClick={() => dispatch(openModalDeleteAction(publication))}
              >
                <Link
                  href=""
                  className="flex items-center gap-2 text-sm py-1.5"
        ...
        <div className="flex flex-col">
          ...
          <p className="text-artistfont/60 sm:text-[14px] text-[12px] cursor-pointer mb-1">
            Ver comentarios
          </p>
          <form className="m-0 p-0">
            <div className="flex justify-between gap-x-3">
              <textarea
                ...
                rows={2}
                className="flex-1 py-0 h-auto resize-none sm:text-[16px] text-[14px] outline-none bg-transparent text-artistfont "
              />
              <div className="flex gap-x-2  w-[100px] text-artistfont">
                ...
                >
                  <span className="text-artist sm:text-[17px] text-[14px] hover:text-artistfont">
                    Publicar
                  </span>
                </button>
