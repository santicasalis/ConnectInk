...
const SideBar = () => {
  ...
  return (
    <>
        <div className={`xl:h-[100vh] overflow-y-scroll fixed xl:static md:w-[40%] ls:w-[30%] xl:w-auto w-[80%] h-full top-0 bg-secondary-900 p-4 flex flex-col justify-between z-30 ${showMenu ? "left-0" : "-left-full"} transition-all`}>
          <div>
            ...
            <ul>
              <li>
                  <Link href='/a-dashboard/home' className='flex items-center rounded-md border-b-[1px] border-white/20 font-newrocker gap-4 px-4 py-5  hover:bg-secondary-100 transition-colors'>
                    <RiStore3Line className='text-primary '/> Home
                  </Link>
              </li>
              <li>
                  <Link href='/a-dashboard/profile' className='w-full flex items-center rounded-md border-b-[1px] border-white/20 font-newrocker justify-between gap-4 px-4 py-5  hover:bg-secondary-100 transition-colors'>
