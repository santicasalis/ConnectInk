...
export default function DashboardLayout({ children }) {
    ...
    const isModalDeleteAppointmentOpen = useSelector((state) => state.modalDeleteAppointment.isOpen);
    return (
          <div className="min-h-screen grid grid-cols-1 xl:grid-cols-6 relative">
                ...
                {isModalDeleteAppointmentOpen && <ModalDeleteAppointment className='absolute'/>}
                <SideBar />
