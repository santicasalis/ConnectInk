      ...
      <div className="bg-secondary-100 h-[200px] mb-[60px] ml-[20px] grid grid-cols-2 w-[60%] rounded relative">
        ...
        <div className=" absolute ml-[190px]">
          <h1 className="text-4xl mb-[20px] flex gap-2 mt-4">
            {" "}
            <VscAccount className="text-primary/75" /> {artist.fullName}
          </h1>
          <h2 className="text-xl flex gap-2 mb-2">
            {" "}
            <CiShop className="text-primary/75" /> {artist.shopName}
          </h2>
          {artist.publications.length === 1 ? (
            <h2 className="text-xl flex gap-2">
              {" "}
              <BsFillFilePostFill className="text-primary/60" />{" "}
            ...
            <h2 className="text-xl flex gap-2">
              {" "}
              <BsFillFilePostFill className="text-primary/60" />{" "}
              {artist.publications.length} Publicaciones{" "}
            </h2>
          )}
        </div>
      </div>
